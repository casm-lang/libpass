...
** Status [[https://travis-ci.org/ppaulweber/libpass][https://api.travis-ci.org/ppaulweber/libpass.svg?branch=master]]
...
The copyright holder of libpass is Philipp Paulweber (@ppaulweber)
and the used license of libpass is a [[https://www.gnu.org/licenses/gpl-3.0.html][GNU GPLv3+]]
